    ...
    componentDidUpdate(prevProps) {
      ...
      if (this.props.sources[0].src !== prevProps.sources[0].src) {
        this.setState({props:this.props}, () => {
          console.log(this.state.props.sources[0])
          this.player = videojs(this.videoNode, this.state.props, function () {
          ...
          console.log("Source:",this.player)
          console.log("Source:",this.videoNode)
        })
      }
    }
